...
dotnet publish -c Release /p:PublishSingleFile=true /p:PublishTrimmed=true --self-contained -r win-x86 -o "%output%/fastgithub_win-x64" ./FastGithub/FastGithub.csproj
